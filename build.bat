...
cmake -B %LOADER_BUILD_DIR% -DCMAKE_INSTALL_PREFIX:PATH=%INSTALL_DIR%\dist -DJSON_SEARCH_PATH=%INSTALL_DIR%\Win32 -DWXWIDGETS_SEARCH_PATH=%INSTALL_DIR%\Win32 -DZLIB_SEARCH_PATH=%INSTALL_DIR%\Win32 -A Win32 %LOADER_SOURCE_DIR%
if %errorlevel% neq 0 exit /b %errorlevel%
