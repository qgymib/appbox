 ...
 */
TEST_F(Reg, ReadKey_MultiLower_ExistsInLower)
{
    /* clang-format off */
    auto tree = FsRoot::Make(GetCWD(), {
        FsDir::Make(L"Upper", {}),
        FsDir::Make(L"Lower1", {
            FsFile::Make(L"%REGISTRY%\\0.reg",
R"REGISTRY(
Windows Registry Editor Version 5.00

[HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion]
"ProductName"="AppBox Test 2"
)REGISTRY")
        }),
        FsDir::Make(L"Lower2", {
            FsFile::Make(L"%REGISTRY%\\1.reg",
R"REGISTRY(
Windows Registry Editor Version 5.00
...
"ProductName"="AppBox Test"
    ...
    ASSERT_EQ(rsp.value, "AppBox Test 2");
}
